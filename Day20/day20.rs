...
fn main() {
    ...
    for line in read_to_string("input.txt").unwrap().lines()
    {
        ...
        {
            node_dest.push(split_line[i].clone());
        }
    ...
    for n in &mut network
    {
        if n.1.0 == '&'
        {
            for m in &net2
            {
                if m.1.3.contains(&n.0)
                {
                    n.1.1.insert(m.0.clone(), -1);
                }
            }
        }
    }
            ...
            if network.contains_key(&p.0)
            {
                ...
                if node.0 == '%'
                {
                    if p.2 == -1
                    {
                        ...
                        {
                            node.2 = 1;
                            for receipient in &node.3
                            {
                                pulses.push((receipient.clone(), p.0.clone(), 1));
                            }
                        }
                        else
                        {
                ...
                if node.0 == 'b'
                {
                    for receipient in &node.3
                    {
                        pulses.push((receipient.clone(), p.0.clone(), p.2));
                    }
                }
            }
        }
    ...
    loop
    {
        ...
        loop
        {
            ...
            {
                if hn_button_presses > 0
                {
                    hn_button_presses = button_presses+1;
                }
                else
                {
                    hn_button_presses = button_presses;
                }
                println!("Part 2: hn {}", hn_button_presses);
            }

            if p.0 == "cs" && p.1 == "lz" && p.2 == 1
            {
                if lz_button_presses > 0
                {
                    lz_button_presses = button_presses+1;
                }
                else
                {
                    lz_button_presses = button_presses;
                }
                println!("Part 2: lz {}", lz_button_presses);
            }

            if p.0 == "cs" && p.1 == "kh" && p.2 == 1
            {
                if kh_button_presses > 0
                {
                    kh_button_presses = button_presses+1;
                }
                else
                {
                    kh_button_presses = button_presses;
                }                
                println!("Part 2: kh {}", kh_button_presses);
            }

            if p.0 == "cs" && p.1 == "tg" && p.2 == 1
            {
                if tg_button_presses > 0
                {
                    tg_button_presses = button_presses+1;
                }
                else
                {
                    tg_button_presses = button_presses;
                }                
                println!("Part 2: tg {}", tg_button_presses);
            }
